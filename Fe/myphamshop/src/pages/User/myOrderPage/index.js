                                            ...
                                            <div className="order-item" key={item.productId}>
                                                <div className="order-item_content">
                                                    <img
                                                        ...
                                                        alt={item.name}
                                                        className="order-item_img"
                                                    />
                                                    <div className="order-item_details">
                                                        <h3 className="order-item_title">{item.name}</h3>
                                                        <p className="order-item_variant">Phân loại hàng: {item.categoryName}</p>
                                                        <p className="order-item_quantity">x{item.soLuong}</p>
                                                    </div>
                                                    <div className="order-item_price">
                                                        <div className="price-original">{formatter(item.price)}</div>
                                                    </div>
                                                </div>
                                                <div className="order-item_total">
                                                    Thành tiền: <span>{formatter(item.totalCost)}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
